    ...
    stream.listen((event) {
      ...
      if (event.snapshot.exists){
        ...
        mydata!.forEach((key, value) {
          print(value['type']);
          if (value['process'] == "Ready" && value['process'] != "Reject" && value['ready'] == 'Accepted' && value['type'] == "Delivery")
          {
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(child: BigText(text: "Done",color: Colors.white,)),
                                  ),
                                ),
                                InkWell(
                                  onTap: isLoading ? null : (){
                                    ...
                                    _getCurrentLocation().then((value){
                                      ...
                                      Get.to(NavigationScreen(lat: -25.5029161,lng: 28.269014,latUser: value.latitude,lngUser: value.longitude, orderNumber: productOrders[index].number,),transition: Transition.leftToRightWithFade);
                                    });
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(child: BigText(text: isLoading ? 'Loading' : "View",color: Colors.white,)),
                                  ),
                                ),
                              ],
                            )
